...
x = np.loadtxt('time-escape-zeroed.txt', unpack=True)
y = np.loadtxt('fluorescence-escape.txt', unpack=True)

def func(x, F, a, k, b):
    return F + a*np.exp(-k*x) + b*x
...
def generate_Initial_Parameters():
    ...
    parameterBounds = [(0,10), (-100, 100), (-100, 100), (0,10)]
